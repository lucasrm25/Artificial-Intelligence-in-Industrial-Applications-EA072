...
% function [w1,w2,eq,CERv,stw1,stw2,rms_w,CER_min,niter_v,niter,nitermax,error_per_class_v] = init_k_folds(n_in,n_hid,n_out,fold,resp)
...
%
function [w1,w2,eq,CERv,stw1,stw2,rms_w,CER_min,niter_v,niter,error_per_class_v] = init_k_folds(n_in,n_hid,n_out,fold,resp)
if resp == 1;
	...
	eq = [];CERv = [];stw1 = [];stw2 = [];rms_w = [];CER_min = [];niter_v = 0;niter = 1;error_per_class_v = [];
